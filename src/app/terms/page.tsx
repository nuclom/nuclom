              ...
              <div className="space-y-8">
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    By accessing and using Nuclom's services, you accept and
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Nuclom provides a video collaboration platform that enables
                    teams to:
                  </p>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    You retain ownership of content you upload to Nuclom.
                    However, you agree not to upload content that:
                  </p>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    modify, suspend, or discontinue any part of our service with
                    or without notice.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Nuclom shall not be liable for any indirect, incidental,
                ...
                <section>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    through our service. Your continued use of the service after
