            ...
            <div id="faq">
              ...
              <div className="space-y-4">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      You can upload videos by clicking the "Upload" button in your workspace, then drag and drop your
                      video files or browse to select them.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Go to your workspace settings, click on "Members," then click "Invite Member" and enter their
                      email address.
                    </p>
                  </CardContent>
                </Card>
