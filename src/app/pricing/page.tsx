...
const pricingPlans = {
  scale: {
    ...
    features: [
      ...
      { name: 'Highlight reels & quote cards', included: true },
      { name: 'Real-time presence', included: true },
      { name: 'Time-stamped comments', included: true },
      { name: '@mentions & notifications', included: true },
      { name: 'Zoom, Meet & Google Drive', included: true },
      { name: 'Slack & MS Teams', included: true },
...
const featureComparison = [
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Quote cards', scale: true, pro: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Comment reactions', scale: true, pro: true },
    ],
  },
  {
