...
- Automatic access based on workspace permissions
...
- Track email opens and video views

**Embed Options**
- Embed videos in websites or presentations
...
- External view statistics
- Engagement rates by sharing method
...
**Knowledge Retention**
- Track how often videos are referenced
...
**Next:** [Team Management Guide](team-management.md)

*Need help with collaboration features? Check our [Troubleshooting Guide](troubleshooting.md) or contact support.*
