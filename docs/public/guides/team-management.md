...
Effective team management is crucial for successful video collaboration. This guide covers inviting members, managing roles and permissions, organizing teams, and maintaining workspace security.
...
- Sets workspace-wide policies
- Manages billing and subscriptions

**Channel Level**
- Subset of workspace members
...
**Viewer**
- View-only access to workspace content
...
**Via Sharing Link**
1. Generate workspace invitation link
...
- **Accepted** - Member has joined workspace
...
*Need help with team management? Check our [Troubleshooting Guide](troubleshooting.md) or contact support.*
