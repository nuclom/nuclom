...
description: "Comprehensive component library built on Radix UI and styled with Tailwind CSS"
icon: "puzzle-piece"
---
...
<AccordionGroup>
  ...
  <Accordion title="OrganizationSwitcher">
    ```typescript
...
|-----|--------|
| Space / K | Play / Pause |
| J / Left Arrow | Skip back 10 seconds |
| L / Right Arrow | Skip forward 10 seconds |
...
<Steps>
  ...
  <Step title="Add to index file (optional)">
    ```typescript
    // src/components/index.ts
    export { MyComponent } from "./my-component";
    ```
  </Step>
  <Step title="Create stories (if using Storybook)">
    ```typescript
...
<CardGroup cols={2}>
  <Card title="Hooks" icon="code" href="/internal/reference/hooks">
    Learn about hooks and utilities
  </Card>
  <Card title="Styling" icon="paintbrush" href="/internal/reference/styling">
