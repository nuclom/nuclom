...
Enterprise customers can configure data residency and multi-region replication.

#### Supported Regions

| Region ID | Location | Data Residency |
|-----------|----------|----------------|
...
| auto | Auto-optimized | None |

#### Data Residency Compliance

When a data residency requirement is set, only regions within that territory are allowed:
...
- `src/lib/multi-region-storage.ts` - Multi-region storage service
...
- `src/app/api/organizations/[id]/storage/` - Storage configuration API
