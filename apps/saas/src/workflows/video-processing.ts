 ...
 */
function needsTitleGeneration(title?: string): boolean {
 ...
 */
async function generateVideoTitle(transcript: string): Promise<string | null> {
  'use step';
 ...
 */
async function saveVideoTitle(videoId: string, title: string): Promise<void> {
  'use step';
