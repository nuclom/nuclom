...
export default function () {
  ...
  const sessionCookie = cookies['better-auth.session_token'] ? cookies['better-auth.session_token'][0].value : null;
  ...
  if (sessionCookie) {
    ...
    const logoutResponse = http.post(`${baseUrl}/api/auth/sign-out`, null, {
      headers: {
        ...HEADERS,
        Cookie: `better-auth.session_token=${sessionCookie}`,
      },
