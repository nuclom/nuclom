...
import { ThumbsUp, Share2, Bookmark, MessageSquarePlus, Github, Code, ListTodo, Sparkles } from "lucide-react"
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-8">
      ...
      <div className="lg:col-span-2 xl:col-span-3 flex flex-col gap-6">
        <header>
          <h1 className="text-2xl md:text-3xl font-bold tracking-tight">Video Title for ID: {params.id}</h1>
